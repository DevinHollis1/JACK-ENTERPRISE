        ...
        <main id="main">
          ...
          <section id="section-b" className="grid">
            <ul>
              <li>
                <div className="card">
                  <img src="https://github.com/cljenkinsjr/jackr-enterprises-site/blob/main/assets/images/redsea-1-1024x768.jpg?raw=true" alt="" />
              ...
              <li>
                <div className="card">
                  <img src="https://github.com/cljenkinsjr/jackr-enterprises-site/blob/main/assets/images/cavern.jpg?raw=true" alt="" />
                  <div className="card-content">
              ...
              <li>
                <div className="card">
                  <img src="https://github.com/cljenkinsjr/jackr-enterprises-site/blob/main/assets/images/fiji-islands.jpg?raw=true" alt="" />
                  <div className="card-content">
              ...
              <li>
                <div className="card">
                  <img src="https://github.com/cljenkinsjr/jackr-enterprises-site/blob/main/assets/images/trek-to-k2-2.jpg?raw=true" alt="" />
                  <div className="card-content">
              ...
              <li>
                <div className="card">
                  <img src="https://github.com/cljenkinsjr/jackr-enterprises-site/blob/main/assets/images/toucan-barbet.jpg?raw=true" alt="" />
                  <div className="card-content">
